...
const Contact = () => {
  ...
  return (
    ...
    >
      <h2 className="mb-[30px] mt-12 font-kaushan text-3xl text-pink-global md:text-[2.4rem] lg:mt-24 lg:text-[2.4rem]border-b-2 border-gray-300">
        Me contacter
      </h2>
      <div className="lg:flex lg:gap-20 ">
        ...
        <div className="mb-5 mt-16  w-full rounded-lg border border-gray-100 bg-gray-100 px-4 py-8 shadow-md md:p-10 lg:mt-10 lg:w-2/5">
          ...
          >
            <a
              href="https://www.google.com/maps?q=48.8566,2.3522"
              target="blank"
              title="Localisation"
              className="flex items-center gap-4"
            >
